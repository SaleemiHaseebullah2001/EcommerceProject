...
<%--                                        <button class="remove_item btn-danger" onclick="remove_item()">X</button>--%>
                                    ...
                                    <td class="product-subtotal">
                                        <span class="amount" id="subtotal">€<%= item.getQuantity() * item.getProduct().getPrice()%></span>
                                    </td>
                                </tr>
                                <% } %>
                                <tr>
...
<script> $(document).ready(function () {
    $(".qty").change(function () {
        ...
        currentRow.find("#subtotal").text("€" + currentRow.find("#price").text().replace("€","") * $(this).val());
        if ($(this).data('old-value') < $(this).val()) {
            alert(currentRow.find("#price").text());
        } else {
            alert(currentRow.find(".item_id").val());
        }
        $.ajax({
            type: "POST",
            url: "add_item",
