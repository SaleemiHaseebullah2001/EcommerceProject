...
public class ProductDAO {
    ...
    private static final String SELECT_PRODUCT_BY_ID_SQL = "SELECT id_img,image, name, price, description FROM product WHERE id_img=?";
    ...
    public List <Product> getAllProducts() throws SQLException {
        ...
        try(Connection connection = getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL_SQL)){
            ...
            while (resultSet.next()){
                int id = resultSet.getInt("id_img");
